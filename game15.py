...
def load_player_data():
    global total_points, player_speed, projectile_speed, projectile_lifetime
    if os.path.exists('player_data.json'):
        with open('player_data.json', 'r') as file:
            data = json.load(file)
            total_points = data.get('total_points', 0)
            player_speed = data.get('player_speed', 5)
            projectile_speed = data.get('projectile_speed', 10)
            projectile_lifetime = data.get('projectile_lifetime', 500)
...
def shop_screen():
    ...
    while shop_running:
        ...
        player_speed_button_rect = pygame.Rect(WIDTH // 3 - 75, HEIGHT // 2 - 90, 150, 50)
        projectile_speed_button_rect = pygame.Rect(WIDTH // 3 - 75, HEIGHT // 2 - 30, 150, 50)
        projectile_distance_button_rect = pygame.Rect(WIDTH // 3 - 75, HEIGHT // 2 + 30, 150, 50)
        back_button_rect = pygame.Rect(WIDTH // 3 - 75, HEIGHT // 2 + 90, 150, 50)
