...
GREEN = (0, 255, 0)
BLACK = (0, 0, 0)
PURPLE = (160, 32, 240)  # Adjusted to a more purple color
PINK = (255, 20, 147)
GOLD = (255, 215, 0)
...
def spawn_enemy():
    ...
    while True:
        ...
        if rarity_roll < 0.0026:
            new_enemy["color"] = GOLD
            new_enemy["hit_points"] = 5
            new_enemy["points"] = 10
        elif rarity_roll < 0.0086:
            new_enemy["color"] = RED
            new_enemy["hit_points"] = 4
            new_enemy["points"] = 8
        elif rarity_roll < 0.0406:
            new_enemy["color"] = PINK
            new_enemy["hit_points"] = 3
            new_enemy["points"] = 6
        elif rarity_roll < 0.2004:
            new_enemy["color"] = PURPLE
            new_enemy["hit_points"] = 2
            new_enemy["points"] = 4
        else:
            new_enemy["color"] = BLUE
            new_enemy["hit_points"] = 1
            new_enemy["points"] = 2
